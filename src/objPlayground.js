...
const calculator = (number1, number2) => {
  ...
  let divisao = Math.floor(number1 / number2);
  let subtracao = number1 - number2;
  objectCalculator.sum = soma;
  objectCalculator.mult = multiplicacao;
  objectCalculator.div = divisao;
  objectCalculator.sub = subtracao;
  console.log(objectCalculator);
